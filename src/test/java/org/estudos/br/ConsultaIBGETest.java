...
public class ConsultaIBGETest {
    ...
    public void testConsultarDistrito() throws IOException {
        // Arrange
        int id = 520005005; // Define o estado a ser consultado
    ...
    @Test
    @DisplayName("Teste para consulta única de um estado por id")
    public void testConsultarEstadoById() throws IOException {
        // Arrange
        int id = 35; // Define o estado a ser consultado

        // Act
        String resposta = ConsultaIBGE.consultarEstadoById(id); // Chama o método a ser testado
    ...
    @Test
    @DisplayName("Teste para consulta única de uma região por id")
    public void testConsultarRegiaoById() throws IOException {
        // Arrange
        int id = 3; // Define o estado a ser consultado

        // Act
        String resposta = ConsultaIBGE.consultarRegiaoById(id); // Chama o método a ser testado
